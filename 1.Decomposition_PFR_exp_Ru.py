...
#%% data load
parameter_data = pd.read_csv('decomposition LHHW aspen parameter Ru.csv',encoding='CP949')

#%%
#set
#T_C_list = [600,550,500,450,400] #°C
T_C_list = list(range(400, 610, 10)) #[500,450,400,350,300] #°C
#T_C = 450 #°C
...
for T_C in T_C_list:
    for GHSV in GHSV_list:
        ...
        save_file = saving_path.format('PFR_exp', T_C, GHSV, 'Ru') 
