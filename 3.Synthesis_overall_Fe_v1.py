...
LCOH_domestic = Opex.solarPV_LOCH(solar_irradiance_rich)[0]
...
link.Visible = False # False

#%%

results = sim_NH3_syn_Fe(link, solar_irradiance_rich, cat_idx, T_C, P_bar, GHSV)
